========================================================================
    ACTIVE TEMPLATE LIBRARY : vs2015_atlproj Project Overview
========================================================================

AppWizard has created this vs2015_atlproj project for you to use as the starting point for
writing your Executable (EXE).

This file contains a summary of what you will find in each of the files that
make up your project.

vs2015_atlproj.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

vs2015_atlproj.vcxproj.filters
...
vs2015_atlproj.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (vs2015_atlproj.h)
        GUID definitions                                (vs2015_atlproj_i.c)
        A type library                                  (vs2015_atlproj.tlb)
        Marshaling code                                 (vs2015_atlproj_p.c and dlldata.c)

vs2015_atlproj.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in vs2015_atlproj.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named vs2015_atlproj.pch and a precompiled types file named StdAfx.obj.
...
vs2015_atlprojps.vcxproj
	...
	dlldata.c, vs2015_atlproj_i.c and vs2015_atlproj_p.c which are required
	to build the proxy/stub DLL.

vs2015_atlprojps.vcxproj.filters
