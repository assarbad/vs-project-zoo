========================================================================
    ACTIVE TEMPLATE LIBRARY : vs2010_atlproj Project Overview
========================================================================

AppWizard has created this vs2010_atlproj project for you to use as the starting point for
...
vs2010_atlproj.vcxproj.filters
...
vs2010_atlproj.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (vs2010_atlproj.h)
        GUID definitions                                (vs2010_atlproj_i.c)
        A type library                                  (vs2010_atlproj.tlb)
        Marshaling code                                 (vs2010_atlproj_p.c and dlldata.c)

vs2010_atlproj.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in vs2010_atlproj.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named vs2010_atlproj.pch and a precompiled types file named StdAfx.obj.
...
vs2010_atlprojps.vcxproj
	...
	dlldata.c, vs2010_atlproj_i.c and vs2010_atlproj_p.c which are required
	to build the proxy/stub DLL.

vs2010_atlprojps.vcxproj.filters
